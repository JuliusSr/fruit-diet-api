...
public class FruitDietService {
    ...
    public NutritionalData getNutritionalDataDifference(String baselineFruitName, String comparedFruitName) {
        return null; //TODO
    }

    public NutritionalData getFruitFamilyNutritionalDataAverage(String family) {
        return null; //TODO
    }
